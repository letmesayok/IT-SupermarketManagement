    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">出售商品信息</a>
                </li>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                        ...
                        <div class="nest" id="validationClose">
                            ...
                            <div class="body-nest" id="validation">
                                <div class="form_center">
                                    ...
                                    <form action="JinhuoxinxiServlet" method = "post">
                                        <fieldset>
                                            ...
                                            <br>                               
                                                ...
                                                <div class="well">
                                                    ...
                                                    <input type="text"  placeholder="Product_price....." class="form-control" required="required" class="form-control" name="Product_price" id="email" oninvalid="setCustomValidity('Product_name is empty')" oninput="setCustomValidity('')">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                             ...
                                             <input class="form-control" placeholder="dd/MM/yyyy-hh:mm:ss....." data-format="dd/MM/yyyy-hh:mm:ss" type="text" required="required" name="Product_storedate" oninvalid="setCustomValidity('Product_storedate is empty')" oninput="setCustomValidity('')">
                                           ...
                                           <div class="control-group">
                                                ...
                                                <br>
                                                <div class="controls">
                                                    <input type="text" placeholder="Product_number....." class="form-control" name="Storenumber" id="name" required="required" oninvalid="setCustomValidity('Storenumber is empty')" oninput="setCustomValidity('')">
                                                </div>
                                            </div>
                                            <div class="form-actions" style="margin:20px 0 0 0;">
                                                <a href = "JinhuoxinxiServlet"><button type="submit" class="btn btn-primary">Submit</button></a>
