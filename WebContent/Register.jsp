                    ...
                    <div class="account-box"> 
                        <form action="RegisterServlet" method="post">
                            <div class="form-group">
                                ...
                                <label for="inputUsernameEmail">用户邮箱</label>
                                ...
                                <!-- <input type="text" name="username" id="inputUsernameEmail" class="form-control"> -->
                            </div>
                            <div class="form-group">
                                <!--a href="#" class="pull-right label-forgot">Forgot password?</a-->
                                <label for="inputPassword">密码</label>
                                <input type="password" name="password" placeholder="Password....." class="form-control" required="required" oninvalid="setCustomValidity('Password is empty')" oninput="setCustomValidity('')">
                                <!-- <input type="password" name="password" id="inputPassword" class="form-control"> -->
                            </div>
                            <a href = "RegisterServlet"><button class="btn btn btn-primary pull-right" type="submit">
                             注册
                            </button></a>
                        </form>
