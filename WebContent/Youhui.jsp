                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" class="admin-pic img-circle" src="images/a2.jpg">Hi, Dave Mattew <b class="caret"></b>
                        </a>
                    ...
                    <ul id="menu-showhide" class="topnav menu-left-nest">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="#" title="Table Dynamic"><i class="entypo-menu"></i><span>库存信息</span></a>
                                </li>
                            </ul>
                        </li>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">优惠商品信息</a>
                 <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li><a href="#" title="Sample page 1">降价优惠</a>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li class="pull-right">
...
<!--                                             </th>   -->
                                    ...
                                    <tbody>
											...
											List<Product> list = (List<Product>)session.getAttribute("Youhuilist");
											...
											%>
												...
												<%
												  ...
												  double price=0.8;
												  int pp=Integer.parseInt(product.getProduct_price());
												  price = price*pp;
												%>
												<td>￥<%=df11.format(price)%></td>
												<td><%=product.getProduct_number()%></td>
												<td><%=product.getProduct_storedate()%></td>
												
<%-- 												 <td><a onclick="change1('<%=product.getProduct_name() %>','<%=product.getProduct_price() %>','<%=product.getProduct_number() %>','<%=product.getProduct_storedate()%>')" style="color: white"><button type = "button" class = "btn btn-warning">修改</button></a> </td> --%>
<%-- 												 <td><a href = "Huodexiugaixinxi.jsp?Product_name=<%=product.getProduct_name()%>&Product_price=<%=product.getProduct_price()%>&Product_number=<%=product.getProduct_number()%>&Product_storedate=<%=product.getProduct_storedate()%>"><button type = "button" class = "btn btn-warning">修改</button></a></td> --%>
<%-- 												 <td><a  onclick="shanchu('<%=product.getProduct_name() %>')"  href='http://localhost:8080/Second/DeleteServlet?action=delete&Product_name1=<%=product.getProduct_name()%>'><button class = "btn btn-danger">删除</button></a></td> --%>
<!-- 												 <td><a href= "a"><button type = "button" class = "btn btn-warning">增加</button></a></td> -->
<%-- 												 <td><a href ="http://localhost:8080/Second/YouhuiServlet?Product_name=<%=product.getProduct_name()%>&Product_price=<%=product.getProduct_price()%>&Product_number=<%=product.getProduct_number()%>&Product_storedate=<%=product.getProduct_storedate()%>"><button class = "btn btn-danger">降价</button></a></td>  --%>
											  </tr>
											  <%
											   }
											 %>
					   ...
					   <div  id="dialog1"  style=" background:url(images/3.jpg);position:relative;left:200px;top:100px;width:400px;height:100px;border:#ddd 1px solid; z-index:1;" >
					   <button type="button" class="close" data-dismiss="alert">×</button>
					   <form  action="UpdateServlet" method="post" >
					     <div class="control-group">
                                                <div style="font:30px bolder '微软雅黑'; text-align:center;"class="control-label" for="name"><font color = "white"><strong>修改记录</strong></font></div>
                                                <br>
                                                <div class="controls">
                                                </div>
                        </div>
					    <div class="control-group">
                                                ...
                                                <br>
                                                <div class="controls">
                                                <input id="Product_name1" type="text"  placeholder="Proudct_name1....." class="form-control" required="required" class="form-control" name="Product_name1">
                                                </div>
                        </div>
					    <div class="control-group">
                                                ...
                                                <br>
                                                <div class="controls">
                                                <input id="Product_price1" type="text"  placeholder="Product_price....." class="form-control" required="required" class="form-control" name="Product_price1">
                                                </div>
                        </div> 
                         
                        <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">商品数量:</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Product_number1" type="text"  placeholder="Product_number1....." class="form-control" required="required" class="form-control" name="Product_number1">
                                                </div>
                         </div>
                          <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">进货日期:</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Product_storedate1" type="text"  placeholder="Product_storedate....." class="form-control" required="required" class="form-control" name="Product_storedate1">
                                                </div>
                         </div>				  
					     <br>
					    <label>
					   <div class = "tp" >
                          <a href = "UpdateServlet" ><button class="btn btn-warning" >修改</button></a>
    ...
    <script>
     ...
     <script type="text/javascript">
           ...
           confirm( '您要删除商品名称为'+Product_name+'的记录吗？');
          <%--  parent.window.location.href = '/DeleteServlet?action=delete&Product_name1<%=Product_name%>' --%> 
      }
           function jiangjia(Product_name){
               confirm('您决定让'+Product_name+'降价吗');
              <%--  parent.window.location.href = '/DeleteServlet?action=delete&Product_name1<%=Product_name%>' --%> 
          }
 ...
 <script type="text/javascript">
     $(function() {
       ...
       function change1(Product_name,Product_price,Product_number,Product_storedate){
       document.getElementById('Product_name1').value=Product_name;
       document.getElementById('Product_price1').value=Product_price;
       document.getElementById('Product_number1').value=Product_number;
       document.getElementById('Product_storedate1').value=Product_storedate;
       $("#dialog1").dialog({
//     	  wdith:500,
//     	  height:500,
//           title:"修改记录"
