...
<!--                         </li> -->
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">信息管理</a>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li><a href="#" title="Sample page 1">修改删除</a>
                </li>
                <li class="pull-right">
            ...
            <div class="content-wrap">
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                <div class="row" style="margin-bottom:10px;">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="filter-status form-control">
                                            <option value="active">充足
                                            <option value="disabled">不足
                                            
                                        </select>
                                    </div>
                                    <div class="col-sm-6">

                                        <a href="#clear" style="margin-left:10px;" class="pull-right btn btn-info clear-filter" title="clear filter">清除信息</a>
                                        <a href="#api" class="pull-right btn btn-info filter-api" >检索记录</a>
                                    </div>
                                </div>
                                <table id="footable-res2" class="demo" data-filter="#filter" data-filter-text-only="true" data-page-size="4">
                                    <thead>
                                        <tr>
                                            <th >
                                                                                                                                                                          售货员                                                                                                         
                                    ...
                                    <tbody>
											...
											List<SaleRecord> list = (List<SaleRecord>)session.getAttribute("Xiaoshoulist");
											for(SaleRecord saleRecord: list){
											%>
												<tr>
												<td><%=saleRecord.getSale_Administrator()%></td>
												<td><%=saleRecord.getSale_Productname()%></td>
												<td>￥<%=saleRecord.getSale_Productprice()%></td>
												<td><%=saleRecord.getSale_date()%></td>
												<td><%=saleRecord.getSale_Productnumber()%></td>
												<td><%=saleRecord.getSale_Profit()%></td>
												  <td><a onclick="change1('<%=saleRecord.getSale_Administrator() %>','<%=saleRecord.getSale_Productname()%>','<%=saleRecord.getSale_Productprice() %>','<%=saleRecord.getSale_date()%>','<%=saleRecord.getSale_Productnumber()%>','<%=saleRecord.getSale_Profit()%>')"style="color: white"><button type = "button" class = "btn btn-warning">修改</button></a> </td>
												  <td><a  onclick="shanchu('<%=saleRecord.getSale_Administrator()%>')"  href='http://localhost:8080/Second/ShanchuSaleRecordServlet?action=delete&Sale_date1=<%=saleRecord.getSale_date()%>'><button class = "btn btn-danger">删除</button></a></td>
											  </tr>
											  <%
											   }
											 %>
					   ...
					   <div  id="dialog1"  style=" background:url(images/4.jpg);position:relative;left:200px;top:100px;width:400px;height:100px;border:#ddd 1px solid; z-index:1;" >
					   <button type="button" class="close" data-dismiss="alert">×</button>
					   <form  action="XiugaiRecordServlet" method="post" >
					     <div class="control-group">
					     <div style="font:30px bolder '微软雅黑'; text-align:center;"class="control-label" for="name"><font color = "white"><strong>修改删除</strong></font></div>
                         ...
                         <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">售货员:</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Sale_Administrator1" type="text"  placeholder="Sale_Administrator1....." class="form-control" required="required" class="form-control" name="Sale_Administrator1">
                                                </div>
                        </div>
					    <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">商品名称:</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Sale_Productname1" type="text"  placeholder="Sale_Productname1....." class="form-control" required="required" class="form-control" name="Sale_Productname1">
                                                </div>
                        </div>
					    <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">商品价格:</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Sale_Productprice1" type="text"  placeholder="Sale_Productprice....." class="form-control" required="required" class="form-control" name="Sale_Productprice1">
                                                </div>
                        </div> 
                         
                        <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">出售数量:</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Sale_Productnumber1" type="text"  placeholder="Sale_Productnumber1....." class="form-control" required="required" class="form-control" name="Sale_Productnumber1">
                                                </div>
                         </div>
                          <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">出售日期:</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Sale_date1" type="text"  placeholder="Sale_date1....." class="form-control" required="required" class="form-control" name="Sale_date1">
                                                </div>
                         </div>		
                          <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">销售利润:</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Sale_Profit1" type="text"  placeholder="Sale_Profit....." class="form-control" required="required" class="form-control" name="Sale_Profit1">
                                                </div>
                         </div>				  
					     <br>
					    <label>
					   <div class = "tp" >
                          <a href = "XiugaiRecordServlet" ><button class="btn btn-danger" >修改</button></a>
                        </div>
					    </label>
    ...
    <script>
     ...
     <script type="text/javascript">
           function shanchu(Product_name){
           confirm( '您要删除'+Product_name+'的这条销售记录吗？');
          <%--  parent.window.location.href = '/DeleteServlet?action=delete&Product_name1<%=Product_name%>' --%> 
      }
 ...
 <script type="text/javascript">
     $(function() {
       ...
       function change1(Sale_Administrator,Sale_Productname,Sale_Productprice,Sale_date,Sale_Productnumber,Sale_Profit){
       document.getElementById('Sale_Administrator1').value=Sale_Administrator;
       document.getElementById('Sale_Productname1').value=Sale_Productname;
       document.getElementById('Sale_Productprice1').value=Sale_Productprice;
       document.getElementById('Sale_date1').value=Sale_date;
       document.getElementById('Sale_Productnumber1').value=Sale_Productnumber;
       document.getElementById('Sale_Profit1').value=Sale_Profit;
       $("#dialog1").dialog({
//     	  wdith:500,
//     	  height:500,
//           title:"修改记录"
