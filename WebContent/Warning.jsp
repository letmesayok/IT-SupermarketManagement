...
<!--                         </li> -->
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">预警信息</a>
                </li>
                <li class="pull-right">
                            ...
                            <div class="body-nest" id="Filtering">
                                ...
                                <div class="row" style="margin-bottom:10px;">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <a href="#api" class="pull-right btn btn-info filter-api" title="Filter using the Filter API">检索记录</a>
                                    </div>
 ...
 -->                                            
                                    ...
                                    <tbody>
											...
											List<Product> list = (List<Product>)session.getAttribute("WarningProductlist");
											...
											%>
												...
												<td><a href = "huodeshanchuxinxi.jsp?Product_name=<%=product.getProduct_name()%>&Product_price=<%=product.getProduct_price()%>&Product_number=<%=product.getProduct_number()%>&Product_storedate=<%=product.getProduct_storedate()%>"><button type = "button" class = "btn btn-danger">删除</button></a></td> --%>
												<td><a href = "Huodexiugaixinxi.jsp?Product_name=<%=product.getProduct_name()%>&Product_price=<%=product.getProduct_price()%>&Product_number=<%=product.getProduct_number()%>&Product_storedate=<%=product.getProduct_storedate()%>"><button type = "button" class = "btn btn-danger">增加</button></a></td>
												 <!-- <td><a href = "a"><button type = "button" class = "btn btn-danger">增加</button></a></td> --> 
											  </tr>
											  <%
											   }
											 %>
