    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">销售总额</a>
                </li>
                <li class="pull-right">
                ...
                <div class="page-extra">
                    ...
                    <section class="content invoice">
                        ...
                        <div class="row">
                            <div class="col-xs-12 invoice-header">
                                <h2 class="page-header">
                                    <i class="fa fa-globe"></i>销售总额
                                    <small class="pull-right">TIME:<%=now %></small>
                                </h2>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-xs-6">
                                <p class="lead">Amount <%="    " %>   <%=now1 %></p>
                                <div class="table-responsive">
                                    <table class="table">
                                        <tr>
                                            <th style="width:50%">进货总支出</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>￥<%=session.getAttribute("sum3")%></td>
                                        </tr>
                                        <tr>
                                            <th>工资总支出</th>
                                            <td>￥35000</td>
                                         ...
                                         <tr>
                                            <th>商店净收益</th>
                                            <td>￥<%=session.getAttribute("sum4")%></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
