...
<!--                         </li> -->
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">退货商品信息管理</a>
                 <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
            ...
            <div class="content-wrap">
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <div class="body-nest" id="Filtering">
                                ...
                                <table id="footable-res2" class="demo" data-filter="#filter" data-filter-text-only="true" data-page-size="4">
                                    ...
                                    <tbody>
											...
											List<TuihuoRecord> list = (List<TuihuoRecord>)session.getAttribute("Tuihuolist");
											for(TuihuoRecord tuihuoRecord: list){
											%>
												<tr>
												<td><%=tuihuoRecord.getCustomer_Tel()%></td>
												<td><%=tuihuoRecord.getProduct_name()%></td>
												<td><%=tuihuoRecord.getProduct_number()%></td>
												<td>￥<%=tuihuoRecord.getProduct_price()%></td>
												</td>
												 <td><a onclick="change1('<%=tuihuoRecord.getCustomer_Tel() %>','<%=tuihuoRecord.getProduct_name() %>','<%=tuihuoRecord.getProduct_price()%>','<%=tuihuoRecord.getProduct_number() %>')" style="color: white"><button type = "button" class = "btn btn-warning">修改</button></a> </td>

												 <td><a  onclick="shanchu('<%=tuihuoRecord.getCustomer_Tel()%>')"  href='http://localhost:8080/Second/DeletetuihuoServlet?action=delete&Customer_Tel=<%=tuihuoRecord.getCustomer_Tel()%>'><button class = "btn btn-danger">删除</button></a></td>
												 <td><a href= "AddTuihuoRecord.jsp"><button type = "button" class = "btn btn-warning">增加</button></a></td> 
											     </tr>
											  <%
											   }
											 %>
					   ...
					   <div  id="dialog1"  style=" background:url(images/2.jpg);position:relative;left:200px;top:100px;width:400px;height:100px;border:#ddd 1px solid; z-index:1;" >
					   <button type="button" class="close" data-dismiss="alert">×</button>
					   <form  action="UpdatetuihuoServlet" method="post" >
					    ...
					    <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">用户号码：</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Customer_Tel" type="text"  placeholder="Customer_Tel....." class="form-control" required="required" class="form-control" name="Customer_Tel">
                                                </div>
                        </div>
					    <div class="control-group">
                                                ...
                                                <br>
                                                <div class="controls">
                                                <input id="Product_name" type="text"  placeholder="Product_name....." class="form-control" required="required" class="form-control" name="Product_name">
                                                </div>
                        </div> 
                        ...
                        <div class="control-group">
                                                ...
                                                <br>
                                                <div class="controls">
                                                <input id="Product_price" type="text"  placeholder="Product_price....." class="form-control" required="required" class="form-control" name="Product_price">
                                                </div>
                         </div>
                          <div class="control-group">
                                                <label class="control-label" for="name"><font color="white" size="4px">退货数量:</font></label>
                                                <br>
                                                <div class="controls">
                                                <input id="Product_number" type="text"  placeholder="Product_number....." class="form-control" required="required" class="form-control" name="Product_number">
                                                </div>
                         </div>				  
					     <br>
					    <label>
					   <div class = "tp" >
                          <a href = "UpdatetuihuoServlet" ><button class="btn btn-danger" >修改</button></a>
    ...
    <script>
     ...
     <script type="text/javascript">
           ...
           confirm( '您要删除用户号码为'+Product_name+'的记录吗？');
 ...
 <script type="text/javascript">
     $(function() {
       ...
       function change1(Customer_Tel,Product_name,Product_price,Product_number){
       document.getElementById('Customer_Tel').value=Customer_Tel;
       document.getElementById('Product_name').value=Product_name;
       document.getElementById('Product_price').value=Product_price;
       document.getElementById('Product_number').value=Product_number;
       $("#dialog1").dialog({
//     	  wdith:500,
//     	  height:500,
//           title:"修改记录"
