    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">销售记录</a>
                </li>
                <li class="pull-right">
                        ...
                        <div class="nest" id="verticalClose">
                            ...
                            <div class="body-nest" id="vertical">
								...
								%>             
                                    ...
                                    <%
                                    int num=1;
                                    for(;i<length&&num<=10;i++,num++)
                                    {%>
                                         <tr>
                                    	 <td><%=list.get(i).getSale_Administrator() %></td>
                                    	 <td><%=list.get(i).getSale_Productname()%></td>
                                    	 <td><%=list.get(i).getSale_Productnumber() %></td>
                                    	 <td>￥<%=list.get(i).getSale_Productprice() %></td>
                                    	 <td><%=list.get(i).getSale_date() %></td>
                                    	 </tr>
                                    	 <%
                                    	 }
                                    	 %>
