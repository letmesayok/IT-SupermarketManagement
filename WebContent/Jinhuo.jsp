                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" class="admin-pic img-circle" src="images/a4.jpg">Hi, Dave Mattew <b class="caret"></b>
                        </a>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">进货信息</a>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li><a href="#" title="Sample page 1">进货记录</a>
                </li>
                <li class="pull-right">
                            ...
                            <div class="body-nest" id="Filtering">
                                ...
                                <table id="footable-res2" class="demo" data-filter="#filter" data-filter-text-only="true" data-page-size="4">
                                    ...
                                    <tbody>
											...
											List<Product> list = (List<Product>)session.getAttribute("JinhuoProductlist");
											for(Product product: list){
											%>
												<tr>
												<td><%=product.getAdministrator_store()%></td>
												<td><%=product.getProduct_name()%></td>
												<td>￥<%=product.getProduct_price()%></td>
												<td><%=product.getStorenumber()%></td>
												...
												<td><a href = "DeleteServlet"><button type="button" name="btn2" id="btn2" value="删除" onclick="return confirm('Yes/No')"type = "button" class = "btn btn-danger">删除</button></a></td>
												 <td><a href= "AddProduct.jsp"><button type = "button" class = "btn btn-warning">增加</button></a></td> --%> 
											  </tr>
											  <%
											   }
											 %>
