                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" class="admin-pic img-circle" src="images/a3.jpg">Hi, Dave Mattew <b class="caret"></b>
                        </a>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">进货商品信息</a>
                </li>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li><a href="#" title="Sample page 1">处理信息</a>
                </li>
                 <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                        ...
                        <div class="nest" id="validationClose">
                            ...
                            <div class="body-nest" id="validation">
                                <div class="form_center">
                                    ...
                                    <form action="AddSaleRecordServlet" method = "post">
                                        <fieldset>
                                            <div class="control-group">
                                                <label class="control-label" for="name">用户邮箱</label> <br>
                                                <br>
                                               <select name="Sale_Administrator" id="selector1" class="form-control1">
																											 <% 
																											 response.setContentType("text/html;charset=utf-8");
										                                                                     List<Administrator> list = (List<Administrator>)session.getAttribute("Administratorlist");
									                                                                    	for(Administrator Administrator: list){
									                                                                              	%>
										                                                                        	<option ><%=Administrator.getAdministrator_name()%></option>
										                                                                           <%
										                                                                           }
										                                                                     %> 
																											</select>
																											<!--  (Administrator_store,Product_name,Product_price,Product_storedate,Product_prenumber,Storenumber,Product_honumber)values(?,?,?,?,?,?,?)";-->
																												<!--  <input type="text" class="form-control1" id="focusedinput" placeholder="用户账号">-->
																												<!-- <input type="text"  class="form-control1" id="focusedinput" name="Administrator_store" value="用户邮箱" required=""> -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <br>
                                                <div class="well">
                                                    <input type="text" class="form-control" name="Sale_Productprice" id="Sale_Productprice"  placeholder="Sale_Productprice....." required="required">
                                                </div>
                                            </div>
                                             <div class="control-group">
                                                ...
                                                <br>
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="Sale_Productname" id="email" placeholder="Sale_Productname....." required="required">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="control-group">
                                                <label class="control-label" for="message" >出售日期</label>
                                                <br>
                                                 <div class="well">
                                            <div id="datetimepicker1" class="input-group date">
                                            <input class="form-control" data-format="dd/MM/yyyy-hh:mm:ss" type="text" name="Sale_date" placeholder="Sale_date....." required="required">
                                           ...
                                           <div class="control-group">
                                                <label class="control-label" for="name">出售数量</label>
                                                <br>
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="Sale_Productnumber" id="Sale_Productnumber" placeholder="Sale_Productnumber....." required="required">
                                                </div>
                                            </div>
                                           
                                            <div class="form-actions" style="margin:20px 0 0 0;">
                                                <a href = "AddSaleRecordServlet"><button type="submit" class="btn btn-primary">增加</button></a>
