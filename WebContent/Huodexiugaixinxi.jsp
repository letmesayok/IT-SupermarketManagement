...
<body>
 <%request.setCharacterEncoding("UTF-8");%>  
    <%
        String Product_name = request.getParameter("Product_name"); // 接收id
        String Product_price = request.getParameter("Product_price"); // 接收姓名
        String Product_number = request.getParameter("Product_number"); // 接收姓名
        String Product_storedate = request.getParameter("Product_storedate"); // 接收姓名
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">修改记录</a>
                </li>
                <li class="pull-right">
                                    ...
                                    <form action="UpdateServlet" method = "post">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="Product_name1" value="<%=Product_name %>" required="" id="name">
                                                </div>
                                            </div>
                                             <div class="control-group">
                                                <label class="control-label" for="name">商品价格</label>
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="Product_price1" value="<%=Product_price%>" required="" id="name">
                                                </div>
                                            </div>
                                             <div class="control-group">
                                                <label class="control-label" for="email">商品数量</label>
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="Product_number1" value="<%=Product_number %>" id="email"  required="">
                                                </div>
                                            </div>
                                            
                                            <div class="control-group">
                                                <label class="control-label" for="message" >进货日期</label>
                                                 <div class="well">
                                        <div id="datetimepicker1" class="input-group date">
                                            <input class="form-control" data-format="dd/MM/yyyy hh:mm:ss" type="text" name="Product_storedate1" value=<%=Product_storedate%> required="">
