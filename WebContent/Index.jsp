    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">主界面</a>
                </li>
                <li class="pull-right">
            ...
            <div id="paper-middle">
                <div id="mapContainer"  >
                   <!-- style="background:url(images/timg.jpg);" -->
            ...
            <!-- <div class="content-wrap">
                ...
                <%--     <div class="col-lg-6">
                        ...
                        <div class="weather-wrap">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="temperature"><b><%=currSun %></b>(<b><%=week %></b>), <%=now1 %>
                                ...
                                <div class="col-lg-8">
                                    <div class="weather-text">
                                        <h2>ZhanDian
                                            <br>
                                            <%
                                              if(now2.compareTo("12")<=0)
                                              {%>
                                             <li>Morning</li>
                                             <% 	  
                                              }
                                              else if(now2.compareTo("17")<=0)
                                              {
                                             %>
                                              <li>Afternoon</li>
                                             <%
